              ...
              {steps.map((step, index) => (
                <div key={step.id} className="w-full">
                  ...
                  `}>
                    ...
                    {step.name === "Document Submission" && (
                      <>
                        {isStepActive(step) && !isStepPassed(step) && !isStepFailed(step) ? (
                          ...
                          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                            <p className="text-[#59c9a5] font-medium">Documents submitted successfully</p>
                          </div>
                        ) : null}
                      </>
                    )}
                    {/* Take-home Project Step */}
                    {step.name === "Take-home Project" && (
                      <>
                        {isStepActive(step) && !isStepPassed(step) && !isStepFailed(step) ? (
                          <TakeHomeProjectForm 
                            step={step}
                          ...
                          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                            <p className="text-[#59c9a5] font-medium">Project completed successfully</p>
                          </div>
                        ) : null}
                      </>
                    )}
                    ...
                    {step.name === "Final Interview" && (
                      <>
                        {isStepActive(step) && !isStepPassed(step) && !isStepFailed(step) ? (
                          ...
                          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                            <p className="text-[#59c9a5] font-medium">Interview completed successfully</p>
                          </div>
                        ) : null}
                      </>
                    )}
